...
```
Lab-01-Disk-Imaging-Hash-Verification/
│
├── README.md (this file)
├── lab-report/
│   └── HW_2-_Lab_2.pdf
│
├── screenshots/
│   ├── screenshot-01-new-files-created.png
│   ├── screenshot-02-md5-hash-verification.png
│   ├── screenshot-03-hash-after-rename.png
│   ├── screenshot-04-hash-after-content-change.png
│   ├── screenshot-05-lab2image2-md5-values.png
│   ├── screenshot-06-dc3dd-execution.png
│   ├── screenshot-07-cli-files-created.png
│   └── screenshot-08-lab2image3-hash.png
│
└── forensic-images/
    ├── lab2image1.E01
    ├── lab2image1.info
